...
Map<String, City> countryHighestPopulatedCities = allCities.values().stream()
...
countryHighestPopulatedCities.forEach((countryCode, highestPopulationCity) ->
        System.out.println("Country Code: " + countryCode + ", Highest Populated City: " + highestPopulationCity.getName() + ", Population: " + highestPopulationCity.getPopulation()));

// Highest populated cities by continent
Map<String, City> continentHighestPopulatedCities = allCountries.values().stream()
...
continentHighestPopulatedCities.forEach((continent, highestPopulationCity) -> {
    System.out.println("Continent: " + continent);
    System.out.println("City Name: " + highestPopulationCity.getName());
    System.out.println("Population: " + highestPopulationCity.getPopulation());
    System.out.println();
});

// Highest populated capital
Optional<City> capitalHighestPopulation = allCountries.values().stream()
        .flatMap(country -> country.getCities().stream()
                .filter(city -> city.getId() == country.getCapital()))
        .max(Comparator.comparingInt(City::getPopulation));

capitalHighestPopulation.ifPresent(highestPopulationCapital -> {
    System.out.println("Highest populated capital City: " + highestPopulationCapital.getName());
    System.out.println("Population: " + highestPopulationCapital.getPopulation());
});
